                    ...
                    <div className={`container ${cClass}`}>
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className={`mrg_left1 navbar-nav menu ml-auto ${nClass}`}>
                                ...
                                <li className="nav-item"><a className="" href={`/cn${navL}`}><img className="flag"  src='/img/china.svg' /></a></li>
                                    
                                
                                :
                                    
                                <li className="nav-item"><a className="" href={`/${navL}`}><img className="flag"  src='/img/uk.svg' /></a></li>
