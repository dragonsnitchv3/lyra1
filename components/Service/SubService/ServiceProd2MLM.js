                    ...
                    <div className=" sec_pad32 col-lg-12 ">
                        <div className="row ">
                            <div className="col-lg-5 sec_pad33">
                                <ProgressiveImage src='/img/home7/SMS.png' placeholder='/img/home7/SMSpre.png'>
                            ...
                            <div className="col-lg-7 pl_70r">
                                <div className="prodm_pg2 txt_gap3">
                                    <p>{content.d0486}</p>
                                    <h1>{content.d0138}<br></br></h1>
                                    <h1>{content.d0138a}<br></br></h1>
                                    <h3>{content.d0138b}<br></br></h3>
                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="prod_desc3">
                                <h1>{content.d0532}</h1> {/* */}
                                <p><span className="f_700 t_color f_size_30 lf_text3p1">{content.d0533}</span>{content.d0563}</p>
                                <p>{content.d0564}</p>
                                <p>{content.d0565}</p>
                            </div>
                        </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6 mt_50r">
                            <div className="prod_desc3">
                                ...
                                <p><span className="f_700 t_color f_size_30 lf_text3p1">{content.d0552}</span>{content.d0550a}</p>
                                <p>{content.d0553}</p>
                            </div>
                        </div>
                    </div>  
