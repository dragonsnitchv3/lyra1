        ...
        <React.Fragment>
                    ...
                    <div className="col-lg-12 sec_pad32">
                        <div className="row ">
                            <div className="col-lg-5 sec_pad33">
                                {/* <img className="img_size_square3d" src='/img/home7/book1.png' /> */}
                                <ProgressiveImage src='/img/home7/book1.png' placeholder='/img/home7/book1pre.png'>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-8">
                            <div className="prod_desc2">
                                <p><span className="f_700 t_color f_size_30 lf_text3">{content.d0509}</span>{content.d0571}</p>
                                <p>{content.d0570}</p>
                                <p>{content.d0572}</p>
                            </div>
                        </div>
            ...
            {/* <section className="tracking_product_area sec_pad32">
                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="prod_desc3">
                                <h1>{content.d0532}</h1> {/* */}
                                <p><span className="f_700 t_color f_size_30 lf_text3p1">{content.d0533}</span>{content.d0574}</p>
                                <p>{content.d0575}</p>
                                <p>{content.d0576}</p>
                            </div>
                        </div>
                ...
                <div className="bk_col5 wrapper_padding5 pt_s50">
                    <div className="prod_desc2 ctr_text mb_70">
                        <h2>{content.d0554d}</h2>
                    </div>
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="prod_desc3">
                                
                                <p><span className="f_700 t_color f_size_30 lf_text3p1">{content.d0549}</span>{content.d0547c}</p>
                                <p>{content.d0548d}</p>
                                <p>{content.d0551}</p>
                            </div>
                        </div>
                        <div className="col-lg-6 mt_50r">
                            <div className="prod_desc3">
                                ...
                                <p><span className="f_700 t_color f_size_30 lf_text3p1">{content.d0552}</span>{content.d0550d}</p>
                                <p>{content.d0553}</p>
                            </div>
                        </div>
                    </div>  
            ...
            {/* <FAQ /> */}
            <Reveal>
            <div className=" wrapper_padding7 sec_pad35 ctr_text">
