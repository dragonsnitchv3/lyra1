        ...
        <React.Fragment>
                    ...
                    <div className="col-lg-12 sec_pad32">
                        <div className="row ">
                            <div className="col-lg-5 sec_pad33">
                                {/* <img className="img_size_square3b" src='/img/home7/ecom1.png'/> */}
                                <ProgressiveImage src='/img/home7/ecom1.png' placeholder='/img/home7/ecom1pre.png'>
                            ...
                            <div className="col-lg-7 pl_70r">
                                <div className="prodm_pg txt_gap3">
                                    <p>{content.d0486}</p>
                                    <h1>{content.d0487b}<br></br></h1>
                                    <h2>{content.d0488}<br></br></h2>
                                    <p>{content.d0489a}<br></br></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {/* <section className="tracking_product_area sec_pad32">
                ...
                <div className="bk_col5 wrapper_padding5 pt_s50">
                    <div className="prod_desc2 ctr_text mb_70">
                        <h2>{content.d0554b}</h2>
                    </div>
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="prod_desc3">
                                
                                <p><span className="f_700 t_color f_size_30 lf_text3p1">{content.d0549}</span>{content.d0547b}</p>
                                <p>{content.d0548b}</p>
                                <p>{content.d0551}</p>
                            </div>
                        </div>
                        <div className="col-lg-6">
                            <div className="prod_desc3">
                                ...
                                <p><span className="f_700 t_color f_size_30 lf_text3p1">{content.d0552}</span>{content.d0550b}</p>
                                <p>{content.d0553}</p>
                            </div>
                        </div>
                    </div>  
