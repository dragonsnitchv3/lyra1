                    ...
                    <div className="col-lg-12 sec_pad32">
                        <div className="row ">
                            <div className="col-lg-5 sec_pad33">
                                <img className="img_size_square3c" src='/img/home7/log1.png' />
                            </div>
                            <div className="col-lg-7 pl_70r">
                                <div className="prodm_pg2 txt_gap3">
                                    <p>{content.d0486}</p>
                                    <h1>{content.d0487c}<br></br></h1>
                                    <h2>{content.d0488}<br></br></h2>
                                    <p>{content.d0489c}<br></br></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-lg-4">
                            <div className="prod_desc2 width1 ctr_text">
                                <h2>{content.d0508a}</h2>
                            </div>
                        </div>
                        <div className="col-lg-8">
                            <div className="prod_desc2">
                                <p><span className="f_700 t_color f_size_30 lf_text3">{content.d0510aa}</span>{content.d0510a}</p>
                                <p>{content.d0511a}</p>
                                <p>{content.d0512a}</p>
                            </div>
                        </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6 mt_50r">
                            <div className="prod_desc3">
                                ...
                                <p><span className="f_700 t_color f_size_30 lf_text3p1">{content.d0552}</span>{content.d0550c}</p>
                                <p>{content.d0553}</p>
                            </div>
                        </div>
                    </div>  
