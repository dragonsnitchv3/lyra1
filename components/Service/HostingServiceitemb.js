...
class HRServiceItems extends Component{
    render(){
        ...
        return(
            <div className="col-lg-6 col-md-6 col-12 mb_15">
                <Link href={Phref}>
                    
                        <div className="hosting_service_itemz lf_text lf_text2">
                            <div className="row">
                                <div className="col-4">
                                ...
                                <div className="col-8 pl_cust lf_text lf_text2 align-items-bottom">
