                                ...
                                <div className="row portfolio_gallery mb_30" id="work-portfolio">
                                {
                                    content.d0056.map((item) => {
                                        return(
                                            ...
                                            <Product2griditem colClass="col-lg-6 col-sm-6 develop" Pduration={item.Pduration} pImg={item.Pimg} Phref={item.Phref} Ptitle={item.Ptitle} Pdescription={item.Pdescription} PtOne={item.PtOne}/>
                                        )
                                    })
                                }
                                </div>
