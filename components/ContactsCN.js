...
class Contacts extends Component {
    ...
    handleSubmit = (e) => {
        ...
        axios({
            method: "POST", 
            url:"https://bknv2-40dv07f6g.vercel.app/send",
                    ...
                    <div className="contact_form col-lg-8">
                        ...
                        <div className="col-lg-3">
                            ...
                            <div className="contact_info_item mt_40">
                                ...
                                <h6 className={`f_p f_size_24 t_color3 f_600 mb_20 ${gap1}`}>{content.d0333}</h6>
                                <p className="f_400 f_size_15 ">{content.d0327}</p>
                            </div>
                            <div className="border_btm1"></div>
                            <div className="contact_info_item sec_pad20">
                                <h6 className={`f_p f_size_24 t_color3 f_600 mb_20 ${gap1}`}>{content.d0334}</h6>
                            ...
                            <div className="contact_info_item border_btm1 sec_pad20">
                                <h6 className={`f_p f_size_24 t_color3 f_600 mb_20 ${gap1}`}>{content.d0335}</h6>
