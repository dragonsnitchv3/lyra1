...
import Product from '../../../components/Service/ServiceApp';
        ...
        return(
            <div className="body_wrapper2">
               <DynamicComponentWithNoSSR />
                ...
                <OnepageMenu slogo="sticky_logo" mClass="menu_four" nClass="w_menu" hbtnClass="btn_get_radious menu_custfive" nLang={cLang} navL="Services/MobileAppDevelopment"/>
                <Product nLang={cLang}/>
