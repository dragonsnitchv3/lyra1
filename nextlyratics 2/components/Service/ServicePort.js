...
import Product2griditem from '../Portfolios/Product2griditem2'
                ...
                <Reveal>
                    <div className="pt_150">
                        <div className="about_pg mb_0">
                            <h1 className="">{content.d0652}<span className="font_col1">{content.d0653}</span><br></br></h1>
                    ...
                    {/* <div className={`seo_sec_title3 mb-30`}>
                        ...
                        <div className="mt-30 sec_pad32a mt-100r">
                            {/* <Fade bottom cascade>
                                    ...
                                    content.d0655.map((item) => {
                                        return(
                                                <Product2griditem colClass="col-xl-4 col-lg-6 col-md-6 col-12 develop" 
                                                    ...
                                                    pImg={item.Pimg} 
                                                    pImg1={item.Pimg1} 
                                                    pImgpre={item.Pimgpre} 
                                                    Phref={item.Phref} 
                                                    Ptitle={item.Ptitle} 
                                                    Pdescription={item.Pdescription} 
                                                    PtOne={item.PtOne}
                                                    PContent={item}
                                                    nLang={this.props.nLang}
                                                />       
                                        )
                                    })
                                }
